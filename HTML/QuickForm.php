...
// +----------------------------------------------------------------------+
//
// $Id: QuickForm.php,v 1.8 2009/08/19 14:39:34 cvs_martin Exp $
...
class HTML_QuickForm extends HTML_Common {
    ...
    */
    ...
    function freezeBlocks($block_names)
    {
        ...
        {
            foreach($this->_elementIndex as $element_name => $element_index)
            {
                $start = strrpos($element_name, '[');
                $block = $start !== false
                         ? substr($element_name, 0, $start)
                         : $element_name;
                if($block == $block_name)
                {
