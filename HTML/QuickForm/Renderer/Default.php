...
// +----------------------------------------------------------------------+
//
// $Id: Default.php,v 1.2 2006/11/23 10:56:06 cvs_roman Exp $
    ...
    */
    function renderElement(&$element, $required, $error)
    {
        if (!$this->_inGroup) {
            ...
            // Da bei Gruppen auch ein Label für jedes Feld angezeigt werden soll
            // muß eine Überprüfung auf Existens und Inhalt erfolgen
            if(isset($element->_label) && !empty($element->_label))
            {
                // Label mit Umruch über das Formularfeld setzen
                $this->_groupElements[] = $element->_label.'<br />'.$element->toHtml();
            }
            else
            {
