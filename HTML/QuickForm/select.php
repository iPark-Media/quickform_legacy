...
// +----------------------------------------------------------------------+
//
// $Id: select.php,v 1.3 2007/03/23 16:14:18 cvs_roman Exp $
    ...
    function onQuickFormEvent($event, $arg, &$caller = null)
    {
        if ('updateValue' == $event) {
            ...
            if (null === $value) {
                ...
                // roman sachse: geandert am 23.03.07 um advmultiselect
                // auch bei multiplen Formulardaten nutzbar zu machen.
                if ((null === $value && (!$caller->isSubmitted() || !$this->getMultiple())) ||
                    (null === $value && is_a($this, 'HTML_QuickForm_advmultiselect'))) {
